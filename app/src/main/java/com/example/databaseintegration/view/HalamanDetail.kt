...
import com.example.databaseintegration.viewmodel.DetailViewModel
import com.example.databaseintegration.viewmodel.StatusUiDetail
    ...
    Column(
        ...
        when (statusUiDetail) {
            is StatusUiDetail.Success -> {
                DetailDataSiswa(
                    siswa = statusUiDetail.statusSiswa,
